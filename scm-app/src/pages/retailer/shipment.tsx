...
const RetailerShipmentPage = () => {
    ...
    const {
        ...
        queryKey: ["retailer", "shipment", userId],
        queryFn: () => getAllShipmentByUserId(userId ?? ""),
        retry: false,
    });

    const handleCreated = () => {
        queryClient.invalidateQueries({ queryKey: ["retailer", "shipment", userId] });
...
export default RetailerShipmentPage;
