...
import { getAllShipmentByUserId } from "@/features/common/shipment/query";
...
const DistributorShipmentPage = () => {
    ...
    const {
        ...
        queryKey: ["distributor", "shipment", userId],
        queryFn: () => getAllShipmentByUserId(userId ?? ""),
        retry: false,
    });

    const handleCreated = () => {
        queryClient.invalidateQueries({ queryKey: ["distributor", "shipment", userId] });
...
export default DistributorShipmentPage;
