...
import { getAllShipmentByUserId, getShipment } from "@/features/common/shipment/query";
...
const FarmerShipmentPage = () => {
    ...
    const {
        ...
        queryKey: ["farmer", "shipment", userId],
        queryFn: () => getAllShipmentByUserId(userId ?? ""),
        retry: false,
    });

    const handleCreated = () => {
        queryClient.invalidateQueries({ queryKey: ["farmer", "shipment", userId] });
...
export default FarmerShipmentPage;
