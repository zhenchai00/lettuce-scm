...
export const getProductBatchById = async (id: string) => {
    const response = await apiClient.get(`/api/farmer/product-batches?id=${id}`)
    return response.data
}
...
export const updateProductBatch = async ({id, data}: UpdateProductBatchData) => {
    const response = await apiClient.put(`/api/farmer/product-batches?id=${id}`, data)
    return response.data
}

export const deleteProductBatch = async (id: string) => {
    const response = await apiClient.delete(`/api/farmer/product-batches?id=${id}`)
    return response.data
}